package net.moddingplayground.example.datagen.impl;

import joptsimple.OptionParser;
import joptsimple.OptionSet;
import joptsimple.OptionSpec;
import net.minecraft.data.DataGenerator;
import net.moddingplayground.example.datagen.impl.provider.AdvancementProvider;
import net.moddingplayground.example.datagen.impl.provider.ItemModelProvider;
import net.moddingplayground.example.datagen.impl.provider.LootTableProvider;
import net.moddingplayground.example.datagen.impl.provider.RecipeProvider;
import net.moddingplayground.example.datagen.impl.provider.StateModelProvider;
import net.moddingplayground.example.datagen.impl.provider.TagProvider;
