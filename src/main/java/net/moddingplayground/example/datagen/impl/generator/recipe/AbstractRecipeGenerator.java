package net.moddingplayground.example.datagen.impl.generator.recipe;
...
import net.moddingplayground.example.datagen.impl.generator.AbstractGenerator;
import net.moddingplayground.example.datagen.impl.mixin.SingleItemRecipeJsonFactoryAccessor;
