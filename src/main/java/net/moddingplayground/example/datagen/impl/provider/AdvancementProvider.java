package net.moddingplayground.example.datagen.impl.provider;

import com.google.common.collect.Maps;
import com.google.gson.JsonElement;
import net.minecraft.data.DataGenerator;
import net.minecraft.util.Identifier;
import net.moddingplayground.example.datagen.impl.DataType;
import net.moddingplayground.example.datagen.impl.generator.advancement.AbstractAdvancementGenerator;
